...
<section class="unknown_user_checkout">
 	<div class="title">
		<?php the_title();?>
	</div>
	...
	<?php if (!is_user_logged_in()) {?>
		...
		<div class="createaccount_info text">
			Your account will be created after the checkout
		</div>
...
<form name="checkout" method="post" class="checkout woocommerce-checkout row" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<?php if ( $checkout->get_checkout_fields() ) : ?>
		...
		if ( !is_user_logged_in() ) : ?>
			...
			<div class="createaccount__wrapper col-md-7">
				...
				<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" class="continueasguest">
		...
		<div class="col-md-7" id="customer_details">
			...
			<div class="buhala-billing-fields">
				<?php do_action( 'woocommerce_checkout_billing' ); ?>
			</div>

			<div class="buhala-add-info">
