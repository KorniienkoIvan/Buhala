...
<section class="product-page container-fluid">
        <div class="row about-product fade-up appear delay-1">
            <div class="col-md-6 col-11 product-gallery">
                <?php if(have_rows('room_images_gallery')):?>
                    <div class="row">
                        <?php $i = 1 ?>
                        <?php while(have_rows('room_images_gallery')): the_row(); ?>
                            <?php if($i == 1 or $i == 2){
            ...
            <div class="col-md-6 col-12 product-details">
                <div class="back-button">
                    <?php $back_button = get_field('room_page_back_button', 'option') ?>
                ...
                <?php if(have_rows('room_details')): ?>
                    <div class="product-short-description">
                        <ul class="product-details-list">
                            ...
                            <li class="list-item"><?php the_sub_field('room_detail') ?></li>
                            <?php endwhile; ?>
                        </ul>
                    </div>
                <?php endif; ?>
                ...
                <div class="share_icons"><?php echo do_shortcode('[Sassy_Social_Share]'); ?></div>
                <?php

                $bookUrl = get_field('book_url');
                if(!$bookUrl) : $bookUrl = "https://buhalaspa.simplybook.it/"; endif; ?>

                <a href="<?php echo $bookUrl; ?>" class="button-wrapper button">Book now!</a>
        ...
        <?php if(have_rows('room-page_reviews_repeater')): ?>
            <section class="reviews">
                <div class="container fade-up appear delay-1">
                    <div class="reviews_title cyan_r3"><?php the_field('room-page_reviews_section_title') ?></div>
                    
                        <div class="reviews_slider">
                            <?php while(have_rows('room-page_reviews_repeater')): the_row(); ?>
                                <div class="reviews_slider_li">
                                    <div class="reviews_slider_li_text karla_r5"><?php the_sub_field('room_review_text') ?></div>
                                    <div class="reviews_slider_li_author karla_r4"><?php the_sub_field('room_review_author') ?></div>
