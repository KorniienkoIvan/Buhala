...
if( function_exists('acf_add_options_page') ) {
  ...
  acf_add_options_sub_page(array(
		'page_title' 	=> 'Theme Rooms Settings',
...
function register_post_types(){
	register_post_type( 'services', [
		...
		'hierarchical'        => false,
		'supports'            => [ 'title', 'editor', 'thumbnail', 'excerpt' ], // 'title','editor','author','excerpt','trackbacks','custom-fields','comments','revisions','page-attributes','post-formats'
		'taxonomies'          => '',
		'has_archive'         => true,
		'rewrite'             => true,
		'query_var'           => true,
  ...
  register_post_type( 'rooms', [
		...
		'labels' => [
			...
			'singular_name'      => 'Rooms', // название для одной записи этого типа
			'add_new'            => 'Add Rooms', // для добавления новой записи
			'add_new_item'       => 'Add Rooms', // заголовка у вновь создаваемой записи в админ-панели.
			'edit_item'          => 'Edit Rooms', // для редактирования типа записи
			'new_item'           => 'New Rooms', // текст новой записи
			'view_item'          => 'View Rooms', // для просмотра записи этого типа.
			'search_items'       => 'Search Rooms', // для поиска по этим типам записи
			'not_found'          => 'Rooms Not Found', // если в результате поиска ничего не было найдено
			'not_found_in_trash' => 'Rooms In Trash', // если не было найдено в корзине
			'parent_item_colon'  => '', // для родителей (у древовидных типов)
...
function create_taxonomy(){
	...
	register_taxonomy( 'rooms_cat', [ 'rooms' ], [
		'label'                 => '',
		'labels'                => [
			'name'              => 'Rooms Category',
			'singular_name'     => 'Rooms Category',
